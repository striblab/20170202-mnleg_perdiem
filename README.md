...
1. Get code and enter project: `git clone https://github.com/striblab/20170202-mnleg_perdiem.git && cd 20170202-mnleg_perdiem.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170202-mnleg_perdiem/ && rsync -rav ./ ../20170202-mnleg_perdiem/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
